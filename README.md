...
Вы можете использовать готовые дистрибутивы платформы, для этого достаточно в папку `distr`. Скрипты сборки будут автоматически использовать их для билда образа.
